...
public class Texto {
	...
	public static byte[] converteStringHexadecimalEmBytes(
		...
		if (tamanho % 2 != 0) {
			throw new NumberFormatException(
					"O tamanho da string hexadecimal est� incorreto!");
		}
	...
	public static byte parseByte(String hex) throws NumberFormatException {
		...
		int n = num.intValue();
		if (n > 255 || n < 0) {
			throw new NumberFormatException(" O n�mero " + n
					+ " n�o pode ser convertido em byte!");
		}
	...
	/**
	 * Inclui o caracter informado � esquerda do texto fornecido, at� que este
	...
	/**
	 * Inclui o caracter informado � direita do texto fornecido, at� que este
	 * tenha o tamanho desejado
	 * 
	 * @param texto
	 *            O texto que se quer completar
    ...
    /**
	 * Compara duas Strings sem levar em conta diferen�as entre mai�sculas e
	 * min�sculas. Esclui carcteres em branco do in�cio e do fim da String. 
     * @return: boolean
     * @param palavra1
     * @param palavra2
     */
	...
	public static String formata(Object valor, String formato) {
		...
		try {
			...
			System.err.println("N�o foi poss�vel aplicar m�scara ao valor: "
					+ valor);
			e.printStackTrace();
			return (String) valor;
		}
